# Users / Deployments (self-reported) — DxP Data Logger Hardware

This file helps (1) estimate adoption, and (2) help the research community find others working on distributed environmental sensing.
Entries are **self-reported** and kept **non-sensitive** (no GPS coordinates).

## Add/Update your entry
Please edit this file via a PR (preferred) or open an issue: “Add me as a user”.
If you’re unsure, approximations are welcome.

## User table
| Name / Organization | First use (YYYY-MM) | Logger HW version | Boards built (approx.) | Purpose / Project description | Location (coarse) | Link (optional) |
|---|---:|---|---|---|---|---|---|
...
- **Purpose / Project description**: e.g., snowpack monitoring, subsurface thermal profiling, soil deformation, research campaign, class/lab tests.
- **Deployment environment**: e.g., above-ground, below-ground, temperate, cold region, mountainous, permafrost region.
- **Location (coarse)**: country / state / region (no exact coordinates).

## Notes (optional)
Feel free to add 1–2 lines about lessons learned or collaborations:
- e.g., “Interested in coordinating probe-array calibration approaches.”
- e.g., “Common integration issues: connector orientation / cabling / enclosure.”